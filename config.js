  ...
  sections: {
    ...
    rules: {
      ...
      blocks: [
        ...
        [textStyle("RISQUE INCENDIE", { color: "red", bold: true }), textStyle("Le camping est sous risque incendie important. Pour cela, merci de respecter IMPERATIVEMENT les règles suivantes:\n- Aucune source de flamme n'est autorisée dans l'enceinte du camping;\n- Seul les équipements à gaz sont acceptés;\n- Merci de ne pas fumer dans les allées et lieux publics du camping; ", { color: "dark" }), "🔥"],
        [textStyle("CONSIGNES D'EVACUATION", { color: "green", bold: true }), textStyle("En cas d'évacuation, merci de vous rassembler au point de rassemblement (citystade), tout en respectant les règles suivantes: En partant du mobilhome,\n- veuillez couper toute source electrique (lumière, climatisation, etc..),\n- ne pas courrir,\n- NE PAS RETOURNER EN ARRIERE,\n- Suivre uniquement le chemin indiqué par les panneaux de signalisation associés (flèche rouge sur fond blanc)\n- Si vos enfants ou autre ne sont pas avec vous, pas d'inquiétude ! Les animateurs et autres membres du personnel les rappatrieront eux aussi au niveau du point de rassemblement", { color: "dark" }), "♻️"],
      ]
    },
    map: {
      interactive: true,
