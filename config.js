...
const CAMPING = {
  ...
  menu: [
    ...
    { id: "departure", icon: "🧳", title: textStyle("Mon départ", { color: "orange", bold: true }), desc: textStyle("Les dernières étapes avant de partir", { color: "gray" }), image: "" }
  ],
  ...
  sections: {
    ...
    // 🧳 MON DÉPART
    // ============================================================
    // Les titres ET les contenus ci-dessous sont modifiables
    ...
    departure: {
      ...
      conclusion: textStyle("👋 Merci pour votre visite ! Bonne route et à bientôt au Camping de Ceyreste ❤️", { color: "green-dark", bold: true, align: "center" })
    },
    stay: {
